  ...
  "equipment": {
    "choice_1": [
      [
        ...
        { "source": "open5e", "location": "armor", "category": "shield" }
      ],
      [
        { "source": "open5e", "location": "weapons", "category": "Marial" },
        { "source": "open5e", "location": "weapons", "category": "Marial" }
      ]
    ],
    "choice_2": [
      [
        { "source": "open5e", "location": "weapons", "key": "javelin", "qty": 5 }
      ],
      [
    ...
    "choice_3": [
      [
        { "source": "data", "location": "equipment_packs", "key": "priests_pack" }
      ],
      [
    ...
    "defaults": [
      ...
      { "source": "data", "location": "adventuring_gear", "key": "holy_symbol" }
    ],
