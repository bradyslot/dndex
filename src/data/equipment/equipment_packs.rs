      ...
      (
        ...
        SRDEquipmentPack {
          ...
          contents: vec![
            ...
            SRDEquipment::AdventuringGear(SRDItem { key: "ball_bearings", source: "adventuring_gear", qty: 1000, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "String (feet)", qty: 10, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "Bell", qty: 1, }),
            SRDEquipment::AdventuringGear(SRDItem { key: "candle", source: "adventuring_gear", qty: 5, }),
            SRDEquipment::AdventuringGear(SRDItem { key: "crowbar", source: "adventuring_gear", qty: 1, }),
      ...
      (
        ...
        SRDEquipmentPack {
          ...
          contents: vec![
            ...
            SRDEquipment::AdventuringGear(SRDItem { key: "case_map_or_scroll", source: "adventuring_gear", qty: 2, }),
      ...
      (
        ...
        SRDEquipmentPack {
          ...
          contents: vec![
            ...
            SRDEquipment::CustomItem(SRDCustomItem { name: "Hammer", qty: 1, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "Piton", qty: 10, }),
            SRDEquipment::AdventuringGear(SRDItem { key: "Torch", source: "adventuring_gear", qty: 10, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "Tinderbox", qty: 1, }),
      ...
      (
        ...
        SRDEquipmentPack {
          ...
          contents: vec![
            ...
            SRDEquipment::CustomItem(SRDCustomItem { name: "Days of rations", qty: 5, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "Waterskin", qty: 1, }),
            SRDEquipment::Tool(SRDItem { key: "disguise_kit", source: "tools", qty: 1, }),
          ]
        },
      ),
      (
      ...
      (
        ...
        SRDEquipmentPack {
          ...
          contents: vec![
            ...
            SRDEquipment::AdventuringGear(SRDItem { key: "candle", source: "adventuring_gear", qty: 10, }),
            SRDEquipment::CustomItem(SRDCustomItem { name: "Tinderbox", qty: 1, }),
